    ...
    <table class="center">
        <thead>
            <tr>
                ...
                <th class="center">Merek Barang</th>
                <th class="center">Jumlah Barang</th>
                <th class="center">Kualitas Barang</th>
        ...
        <tbody>
            @foreach ($data as $row)
                <tr>
                    <td class="center">{{ $row->id_barang }}</td>
                    <td class="center">{{ $row->merek_barang }}</td>
                    <td class="center">{{ $row->jumlah_barang }}</td>
                    <td class="center">{{ $row->kualitas_barang }}</td>
